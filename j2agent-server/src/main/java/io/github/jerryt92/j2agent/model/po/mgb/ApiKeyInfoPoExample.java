...
public class ApiKeyInfoPoExample {
     ...
     * @mbg.generated
     */
    public ApiKeyInfoPoExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ApiKeyInfoPoExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ApiKeyInfoPoExample page(Integer page, Integer pageSize) {
