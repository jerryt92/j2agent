...
public class ObjectUploadReconcileQueueService {
    static final String READY_QUEUE = "j2agent:upload:reconcile:ready";
    static final String CANCELLED_SET = "j2agent:upload:reconcile:cancelled";
    static final String HEARTBEAT_PREFIX = "j2agent:upload:reconcile:heartbeat:";
    ...
    public ObjectUploadReconcileQueueService(
        ...
        this.cancelledKeys = redissonClient.getSet(CANCELLED_SET, StringCodec.INSTANCE);
    }
    ...
    private RBucket<String> heartbeatBucket(String objectKey) {
        return redissonClient.getBucket(HEARTBEAT_PREFIX + objectKey, StringCodec.INSTANCE);
    }
}
