...
public class ContextRecordPoExample {
    /**
     ...
     * @mbg.generated
     */
    public ContextRecordPoExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ContextRecordPoExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ContextRecordPoExample page(Integer page, Integer pageSize) {
     ...
     * This class corresponds to the database table context_record
     *
     * @mbg.generated
     */
